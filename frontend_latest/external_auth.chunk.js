...
const externalForwardHaptics = (bus) => window.addEventListener("haptic", (ev) => bus.fireMessage({ type: "haptic", payload: { hapticType: ev.detail } }));
