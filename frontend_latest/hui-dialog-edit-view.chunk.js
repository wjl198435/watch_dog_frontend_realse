...
let HuiDialogEditView = class HuiDialogEditView extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
...
let HuiEditView = class HuiEditView extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    constructor() {
        super();
        this._saving = false;
        this._curTabIndex = 0;
    ...
    async showDialog() {
        ...
        if (this.viewIndex === undefined) {
            ...
            const _a = this.lovelace.config.views[this.viewIndex], { cards, badges } = _a, viewConfig = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["cards", "badges"]);
    ...
    render() {
        ...
        switch (this._curTab) {
            case "tab-settings":
                content = lit_element__WEBPACK_IMPORTED_MODULE_1__["html"] `
          <hui-view-editor
    ...
    async _delete() {
        ...
        try {
            await this.lovelace.saveConfig(Object(_config_util__WEBPACK_IMPORTED_MODULE_15__["deleteView"])(this.lovelace.config, this.viewIndex));
            this._closeDialog();
    ...
    async _save() {
        ...
        this._saving = true;
        const viewConf = Object.assign(Object.assign({}, this._config), { badges: this._badges.map((entityConf) => entityConf.entity), cards: this._cards });
        const lovelace = this.lovelace;
        try {
            await lovelace.saveConfig(this._creatingView
...
let HuiViewEditor = class HuiViewEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    constructor() {
        super(...arguments);
    ...
    _valueChanged(ev) {
        ...
        if (target.configValue) {
            newConfig = Object.assign(Object.assign({}, this._config), { [target.configValue]: target.checked !== undefined ? target.checked : target.value });
        }
    ...
    _handleTitleBlur(ev) {
        ...
        const config = Object.assign(Object.assign({}, this._config), { path: Object(_common_string_slugify__WEBPACK_IMPORTED_MODULE_5__["slugify"])(ev.currentTarget.value) });
        Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_3__["fireEvent"])(this, "view-config-changed", { config });
    }
};
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["property"])()
