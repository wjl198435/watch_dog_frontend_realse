...
let IntegrationBadge = class IntegrationBadge extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    constructor() {
        super(...arguments);
...
let OnboardingIntegrations = class OnboardingIntegrations extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    connectedCallback() {
        super.connectedCallback();
        this._unsubEvents = Object(_data_config_flow__WEBPACK_IMPORTED_MODULE_10__["subscribeConfigFlowInProgress"])(this.hass, (flows) => {
    ...
    render() {
        ...
        const discovered = this._discovered.map((flow) => {
            const title = Object(_data_config_flow__WEBPACK_IMPORTED_MODULE_10__["localizeConfigFlowTitle"])(this.hass.localize, flow);
            return [
                title,
                lit_element__WEBPACK_IMPORTED_MODULE_1__["html"] `
        ...
        const content = [...entries, ...discovered]
            .sort((a, b) => Object(_common_string_compare__WEBPACK_IMPORTED_MODULE_5__["compare"])(a[0], b[0]))
            .map((item) => item[1]);
        return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"] `
      <p>
    ...
    async _loadConfigEntries() {
        const entries = await Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_4__["getConfigEntries"])(this.hass);
