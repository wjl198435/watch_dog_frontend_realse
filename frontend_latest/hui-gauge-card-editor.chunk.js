...
let HuiGaugeCardEditor = class HuiGaugeCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    setConfig(config) {
    ...
    _severityChanged(ev) {
        ...
        const target = ev.target;
        const severity = Object.assign(Object.assign({}, this._config.severity), { [target.configValue]: Number(target.value) });
        this._config = Object.assign(Object.assign({}, this._config), { severity });
        Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_7__["fireEvent"])(this, "config-changed", { config: this._config });
    }
    _valueChanged(ev) {
        if (!this._config || !this.hass) {
