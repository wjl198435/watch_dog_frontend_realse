...
class HaPanelCustom extends lit_element__WEBPACK_IMPORTED_MODULE_1__["UpdatingElement"] {
    constructor() {
        super(...arguments);
        ...
        this.navigate = (path, replace) => Object(_common_navigate__WEBPACK_IMPORTED_MODULE_5__["navigate"])(this, path, replace);
    }
...
(Check docs for the panel_custom component to hide this message)`)) {
        ...
        if (!config.embed_iframe) {
            Object(_util_custom_panel_load_custom_panel__WEBPACK_IMPORTED_MODULE_2__["loadCustomPanel"])(config).then(() => {
                const element = Object(_util_custom_panel_create_custom_panel_element__WEBPACK_IMPORTED_MODULE_3__["createCustomPanelElement"])(config);
                this._setProperties = (props) => Object(_util_custom_panel_set_custom_panel_properties__WEBPACK_IMPORTED_MODULE_4__["setCustomPanelProperties"])(element, props);
