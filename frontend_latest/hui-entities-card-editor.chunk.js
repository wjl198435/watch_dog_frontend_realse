...
const cardConfigStruct = Object(_common_structs_struct__WEBPACK_IMPORTED_MODULE_12__["struct"])({
    type: "string",
    title: "string|number?",
    theme: "string?",
...
let HuiEntitiesCardEditor = class HuiEntitiesCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    setConfig(config) {
