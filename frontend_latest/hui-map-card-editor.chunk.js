...
let HuiInputListEditor = class HuiInputListEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    render() {
        if (!this.value) {
...
let HuiMapCardEditor = class HuiMapCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    setConfig(config) {
