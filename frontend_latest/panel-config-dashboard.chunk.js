...
let HaConfigNavigation = class HaConfigNavigation extends lit_element__WEBPACK_IMPORTED_MODULE_7__["LitElement"] {
    render() {
        return lit_element__WEBPACK_IMPORTED_MODULE_7__["html"] `
      <ha-card>
        ${PAGES.map(({ page, core, advanced }) => (core || Object(_common_config_is_component_loaded__WEBPACK_IMPORTED_MODULE_4__["default"])(this.hass, page)) &&
