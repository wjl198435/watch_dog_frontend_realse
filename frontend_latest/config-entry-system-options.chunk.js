...
let DialogConfigEntrySystemOptions = class DialogConfigEntrySystemOptions extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    async showDialog(params) {
        this._params = params;
        this._error = undefined;
        this._loading = true;
        const systemOptions = await Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_6__["getConfigEntrySystemOptions"])(this.hass, params.entry.entry_id);
        this._loading = false;
    ...
    async _updateEntry() {
        ...
        try {
            await Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_6__["updateConfigEntrySystemOptions"])(this.hass, this._params.entry.entry_id, {
