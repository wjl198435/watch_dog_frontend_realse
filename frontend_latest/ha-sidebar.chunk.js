 ...
 */
class HaSidebar extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    constructor() {
        super(...arguments);
        this.alwaysExpand = false;
        this.expanded = false;
        this._defaultPage = localStorage.defaultPage || _common_const__WEBPACK_IMPORTED_MODULE_11__["DEFAULT_PANEL"];
        // property used only in css
        // @ts-ignore
        this._rtl = false;
        this._recentKeydownActiveUntil = 0;
    }
    render() {
      ...
      <a
        class=${Object(lit_html_directives_class_map__WEBPACK_IMPORTED_MODULE_15__["classMap"])({
            profile: true,
    ...
    firstUpdated(changedProps) {
        ...
        if (this.hass && this.hass.auth.external) {
            Object(_external_app_external_config__WEBPACK_IMPORTED_MODULE_12__["getExternalConfig"])(this.hass.auth.external).then((conf) => {
                this._externalConfig = conf;
            });
        }
        Object(_data_persistent_notification__WEBPACK_IMPORTED_MODULE_13__["subscribeNotifications"])(this.hass.connection, (notifications) => {
    ...
    _renderPanel(urlPath, icon, title) {
        return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"] `
      <a
        aria-role="option"
        href="${`/${urlPath}`}"
...
let StateBadge = class StateBadge extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    render() {
