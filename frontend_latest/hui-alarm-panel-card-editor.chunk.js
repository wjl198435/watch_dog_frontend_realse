...
let HuiAlarmPanelCardEditor = class HuiAlarmPanelCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    setConfig(config) {
    ...
    _stateRemoved(ev) {
        ...
        if (index > -1) {
            ...
            this._config = Object.assign(Object.assign({}, this._config), { states: newStates });
