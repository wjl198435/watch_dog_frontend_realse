...
var DialogAreaDetail = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DialogAreaDetail, _super);
    function DialogAreaDetail() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(DialogAreaDetail, "properties", {
        get: function () {
            return {
                _error: {},
                _name: {},
    ...
    DialogAreaDetail.prototype.showDialog = function (params) {
    ...
    DialogAreaDetail.prototype.render = function () {
        if (!this._params) {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_6 || (templateObject_6 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>\n          ", "\n        </h2>\n        <paper-dialog-scrollable>\n          ", "\n          <div class=\"form\">\n            ", "\n\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              label=\"Name\"\n              error-message=\"Name is required\"\n              .invalid=", "\n            ></paper-input>\n          </div>\n        </paper-dialog-scrollable>\n        <div class=\"paper-dialog-buttons\">\n          ", "\n          <mwc-button\n            @click=\"", "\"\n            .disabled=", "\n          >\n            ", "\n          </mwc-button>\n        </div>\n      </ha-paper-dialog>\n    "], ["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>\n          ",
            ...
            "\n\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              label=\"Name\"\n              error-message=\"Name is required\"\n              .invalid=", "\n            ></paper-input>\n          </div>\n        </paper-dialog-scrollable>\n        <div class=\"paper-dialog-buttons\">\n          ",
            "\n          <mwc-button\n            @click=\"", "\"\n            .disabled=", "\n          >\n            ",
            "\n          </mwc-button>\n        </div>\n      </ha-paper-dialog>\n    "])), this._openedChanged, entry
            ? entry.name
            : this.hass.localize("ui.panel.config.area_registry.editor.default_name"), this._error
            ...
            ? Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n                <mwc-button\n                  class=\"warning\"\n                  @click=\"", "\"\n                  .disabled=", "\n                >\n                  ", "\n                </mwc-button>\n              "], ["\n                <mwc-button\n                  class=\"warning\"\n                  @click=\"", "\"\n                  .disabled=", "\n                >\n                  ",
                "\n                </mwc-button>\n              "])), this._deleteEntry, this._submitting, this.hass.localize("ui.panel.config.area_registry.editor.delete")) : Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_5 || (templateObject_5 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])([""], [""]))), this._updateEntry, nameInvalid || this._submitting, entry
    ...
    DialogAreaDetail.prototype._nameChanged = function (ev) {
        this._error = undefined;
        this._name = ev.detail.value;
    };
    DialogAreaDetail.prototype._updateEntry = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var values, err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
    ...
    DialogAreaDetail.prototype._deleteEntry = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    DialogAreaDetail.prototype._openedChanged = function (ev) {
        if (!ev.detail.value) {
            this._params = undefined;
        }
    };
    Object.defineProperty(DialogAreaDetail, "styles", {
        get: function () {
            return [
