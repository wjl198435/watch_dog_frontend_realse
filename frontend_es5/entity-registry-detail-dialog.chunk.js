...
var DialogEntityRegistryDetail = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DialogEntityRegistryDetail, _super);
    function DialogEntityRegistryDetail() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DialogEntityRegistryDetail.prototype.showDialog = function (params) {
    ...
    DialogEntityRegistryDetail.prototype.render = function () {
        if (!this._params) {
        ...
        var invalidDomainUpdate = Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_7__["computeDomain"])(this._entityId.trim()) !==
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>\n          ", "\n        </h2>\n        <paper-dialog-scrollable>\n          ", "\n          ", "\n          <div class=\"form\">\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              .label=", "\n              .placeholder=", "\n              .disabled=", "\n            ></paper-input>\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              .label=", "\n              error-message=\"Domain needs to stay the same\"\n              .invalid=", "\n              .disabled=", "\n            ></paper-input>\n            <div class=\"row\">\n              <ha-switch\n                .checked=", "\n                @change=", "\n              >\n                <div>\n                  <div>\n                    ", "\n                  </div>\n                  <div class=\"secondary\">\n                    ", "\n                    ", "\n                    <br />Note: this might not work yet with all integrations.\n                  </div>\n                </div>\n              </ha-switch>\n            </div>\n          </div>\n        </paper-dialog-scrollable>\n        <div class=\"paper-dialog-buttons\">\n          <mwc-button\n            class=\"warning\"\n            @click=\"", "\"\n            .disabled=", "\n          >\n            ", "\n          </mwc-button>\n          <mwc-button\n            @click=\"", "\"\n            .disabled=", "\n          >\n            ", "\n          </mwc-button>\n        </div>\n      </ha-paper-dialog>\n    "], ["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>\n          ",
            ...
            : "", this.hass.localize("ui.panel.config.entity_registry.editor.enabled_description"), this._deleteEntry, this._submitting, this.hass.localize("ui.panel.config.entity_registry.editor.delete"), this._updateEntry, invalidDomainUpdate || this._submitting, this.hass.localize("ui.panel.config.entity_registry.editor.update"));
    };
    DialogEntityRegistryDetail.prototype._nameChanged = function (ev) {
        this._error = undefined;
        this._name = ev.detail.value;
    };
    DialogEntityRegistryDetail.prototype._entityIdChanged = function (ev) {
        this._error = undefined;
        this._entityId = ev.detail.value;
    };
    DialogEntityRegistryDetail.prototype._updateEntry = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_9__["updateEntityRegistryEntry"])(this.hass, this._origEntityId, {
    ...
    DialogEntityRegistryDetail.prototype._deleteEntry = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, , 3, 4]);
                        return [4 /*yield*/, Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_9__["removeEntityRegistryEntry"])(this.hass, this._entityId)];
                    case 2:
                        _a.sent();
                        this._params = undefined;
                        return [3 /*break*/, 4];
    ...
    DialogEntityRegistryDetail.prototype._openedChanged = function (ev) {
        if (!ev.detail.value) {
            this._params = undefined;
        }
    };
    DialogEntityRegistryDetail.prototype._disabledByChanged = function (ev) {
        this._disabledBy = ev.target.checked ? null : "user";
    };
    Object.defineProperty(DialogEntityRegistryDetail, "styles", {
        get: function () {
            return [
