...
var ZHAConfigPanel = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(ZHAConfigPanel, _super);
        ...
        _this.routerOptions = {
            ...
            routes: {
                configuration: {
                    tag: "ha-config-zha",
                    load: function () {
                        return Promise.all(/*! import() | zha-configuration-page */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e("vendors~dialog-zha-device-info~panel-config-zwave~zha-add-devices-page~zha-configuration-page"), __webpack_require__.e(4), __webpack_require__.e(7), __webpack_require__.e("dialog-zha-device-info~zha-add-devices-page~zha-configuration-page"), __webpack_require__.e("zha-configuration-page")]).then(__webpack_require__.bind(null, /*! ./ha-config-zha */ "./src/panels/config/zha/ha-config-zha.ts"));
                    },
                },
                add: {
                    tag: "zha-add-devices-page",
                    load: function () {
                        return Promise.all(/*! import() | zha-add-devices-page */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e("vendors~hui-dialog-edit-card~hui-entity-button-card-editor~hui-markdown-card-editor~hui-picture-card~0273678c"), __webpack_require__.e("vendors~dialog-zha-device-info~panel-config-zwave~zha-add-devices-page~zha-configuration-page"), __webpack_require__.e(4), __webpack_require__.e(7), __webpack_require__.e("dialog-zha-device-info~zha-add-devices-page~zha-configuration-page"), __webpack_require__.e("zha-add-devices-page")]).then(__webpack_require__.bind(null, /*! ./zha-add-devices-page */ "./src/panels/config/zha/zha-add-devices-page.ts"));
                    },
                },
            },
        };
    ...
    ZHAConfigPanel.prototype.updatePageEl = function (el) {
