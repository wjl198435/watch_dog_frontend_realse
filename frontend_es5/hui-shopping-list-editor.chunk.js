...
var HuiShoppingListEditor = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(HuiShoppingListEditor, _super);
    function HuiShoppingListEditor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HuiShoppingListEditor.prototype.setConfig = function (config) {
        config = cardConfigStruct(config);
        this._config = config;
    };
    Object.defineProperty(HuiShoppingListEditor.prototype, "_title", {
        get: function () {
    ...
    HuiShoppingListEditor.prototype.render = function () {
        if (!this.hass) {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <div class=\"card-config\">\n        <paper-input\n          .label=\"", " (", ")\"\n          .value=\"", "\"\n          .configValue=\"", "\"\n          @value-changed=\"", "\"\n        ></paper-input>\n      </div>\n    "], ["\n      <div class=\"card-config\">\n        <paper-input\n          .label=\"",
            " (",
            ")\"\n          .value=\"", "\"\n          .configValue=\"", "\"\n          @value-changed=\"", "\"\n        ></paper-input>\n      </div>\n    "])), this.hass.localize("ui.panel.lovelace.editor.card.generic.title"), this.hass.localize("ui.panel.lovelace.editor.card.config.optional"), this._title, "title", this._valueChanged);
    };
    HuiShoppingListEditor.prototype._valueChanged = function (ev) {
        var _a;
