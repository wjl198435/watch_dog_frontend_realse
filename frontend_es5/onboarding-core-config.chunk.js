...
var OnboardingCoreConfig = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(OnboardingCoreConfig, _super);
    function OnboardingCoreConfig() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._working = false;
        return _this;
    }
    OnboardingCoreConfig.prototype.render = function () {
    ...
    OnboardingCoreConfig.prototype.firstUpdated = function (changedProps) {
        var _this = this;
        _super.prototype.firstUpdated.call(this, changedProps);
        setTimeout(function () { return _this.shadowRoot.querySelector("paper-input").focus(); }, 100);
    ...
    Object.defineProperty(OnboardingCoreConfig.prototype, "_nameValue", {
        get: function () {
    ...
    Object.defineProperty(OnboardingCoreConfig.prototype, "_locationValue", {
        get: function () {
    ...
    Object.defineProperty(OnboardingCoreConfig.prototype, "_elevationValue", {
        get: function () {
    ...
    Object.defineProperty(OnboardingCoreConfig.prototype, "_timeZoneValue", {
        get: function () {
    ...
    Object.defineProperty(OnboardingCoreConfig.prototype, "_unitSystemValue", {
        get: function () {
    ...
    OnboardingCoreConfig.prototype._handleChange = function (ev) {
        var target = ev.currentTarget;
        this["_" + target.name] = target.value;
    };
    OnboardingCoreConfig.prototype._locationChanged = function (ev) {
        this._location = ev.currentTarget.location;
    };
    OnboardingCoreConfig.prototype._unitSystemChanged = function (ev) {
        this._unitSystem = ev.detail.value;
    };
    OnboardingCoreConfig.prototype._detect = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var values, err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Object(_data_core__WEBPACK_IMPORTED_MODULE_6__["detectCoreConfig"])(this.hass)];
                    case 2:
                        values = _a.sent();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        alert("Failed to detect location information: " + err_1.message);
                        return [3 /*break*/, 5];
                    case 4:
                        this._working = false;
                        return [7 /*endfinally*/];
    ...
    OnboardingCoreConfig.prototype._save = function (ev) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var location_1, result, err_2;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ev.preventDefault();
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Object(_data_core__WEBPACK_IMPORTED_MODULE_6__["saveCoreConfig"])(this.hass, {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, Object(_data_onboarding__WEBPACK_IMPORTED_MODULE_7__["onboardCoreConfigStep"])(this.hass)];
                    case 3:
                        result = _a.sent();
    ...
    Object.defineProperty(OnboardingCoreConfig, "styles", {
        get: function () {
