...
var DialogCloudCertificate = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DialogCloudCertificate, _super);
    function DialogCloudCertificate() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DialogCloudCertificate.prototype.showDialog = function (params) {
    ...
    DialogCloudCertificate.prototype.render = function () {
        if (!this._params) {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <ha-paper-dialog with-backdrop>\n        <h2>\n          ", "\n        </h2>\n        <div>\n          <p>\n            ", "\n            ", "<br />\n            (", ")\n          </p>\n          <p class=\"break-word\">\n            ", "\n            ", "\n          </p>\n        </div>\n\n        <div class=\"paper-dialog-buttons\">\n          <mwc-button @click=\"", "\"\n            >", "</mwc-button\n          >\n        </div>\n      </ha-paper-dialog>\n    "], ["\n      <ha-paper-dialog with-backdrop>\n        <h2>\n          ",
            ...
            ")\n          </p>\n          <p class=\"break-word\">\n            ",
            "\n            ", "\n          </p>\n        </div>\n\n        <div class=\"paper-dialog-buttons\">\n          <mwc-button @click=\"", "\"\n            >",
            "</mwc-button\n          >\n        </div>\n      </ha-paper-dialog>\n    "])), this.hass.localize("ui.panel.config.cloud.dialog_certificate.certificate_information"), this.hass.localize("ui.panel.config.cloud.dialog_certificate.certificate_expiration_date"), Object(_common_datetime_format_date_time__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(certificateInfo.expire_date), this.hass.language), this.hass.localize("ui.panel.config.cloud.dialog_certificate.will_be_auto_renewed"), this.hass.localize("ui.panel.config.cloud.dialog_certificate.fingerprint"), certificateInfo.fingerprint, this._closeDialog, this.hass.localize("ui.panel.config.cloud.dialog_certificate.close"));
    };
    Object.defineProperty(DialogCloudCertificate.prototype, "_dialog", {
        get: function () {
    ...
    DialogCloudCertificate.prototype._closeDialog = function () {
        this._dialog.close();
    };
    Object.defineProperty(DialogCloudCertificate, "styles", {
        get: function () {
            return [
