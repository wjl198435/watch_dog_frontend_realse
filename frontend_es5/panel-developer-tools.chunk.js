...
var DeveloperToolsRouter = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DeveloperToolsRouter, _super);
        ...
        _this.routerOptions = {
            ...
            beforeRender: function (page) {
                if (!page || page === "not_found") {
                    ...
                    return _this._currentPage ? _this._currentPage : "info";
                }
                return undefined;
            },
            cacheAll: true,
            ...
            routes: {
                event: {
                    ...
                    load: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(8), __webpack_require__.e(9), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! ./event/developer-tools-event */ "./src/panels/developer-tools/event/developer-tools-event.js")); },
                },
                info: {
                    tag: "developer-tools-info",
                    load: function () { return __webpack_require__.e(/*! import() */ 19).then(__webpack_require__.bind(null, /*! ./info/developer-tools-info */ "./src/panels/developer-tools/info/developer-tools-info.ts")); },
                },
                logs: {
                    tag: "developer-tools-logs",
                    load: function () { return Promise.all(/*! import() */[__webpack_require__.e(6), __webpack_require__.e(7), __webpack_require__.e(13)]).then(__webpack_require__.bind(null, /*! ./logs/developer-tools-logs */ "./src/panels/developer-tools/logs/developer-tools-logs.ts")); },
                },
                mqtt: {
                    tag: "developer-tools-mqtt",
                    load: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(17)]).then(__webpack_require__.bind(null, /*! ./mqtt/developer-tools-mqtt */ "./src/panels/developer-tools/mqtt/developer-tools-mqtt.ts")); },
                },
                service: {
                    tag: "developer-tools-service",
                    load: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e(9), __webpack_require__.e(18), __webpack_require__.e(4), __webpack_require__.e(10), __webpack_require__.e(16)]).then(__webpack_require__.bind(null, /*! ./service/developer-tools-service */ "./src/panels/developer-tools/service/developer-tools-service.js")); },
                },
                state: {
                    tag: "developer-tools-state",
                    load: function () { return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e(5), __webpack_require__.e(9), __webpack_require__.e(4), __webpack_require__.e(14)]).then(__webpack_require__.bind(null, /*! ./state/developer-tools-state */ "./src/panels/developer-tools/state/developer-tools-state.js")); },
                },
                template: {
                    tag: "developer-tools-template",
                    load: function () { return __webpack_require__.e(/*! import() */ 20).then(__webpack_require__.bind(null, /*! ./template/developer-tools-template */ "./src/panels/developer-tools/template/developer-tools-template.js")); },
                },
            },
        };
        return _this;
    }
    DeveloperToolsRouter.prototype.updatePageEl = function (el) {
...
var PanelDeveloperTools = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(PanelDeveloperTools, _super);
    function PanelDeveloperTools() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PanelDeveloperTools.prototype.render = function () {
        var page = this._page;
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <app-header-layout has-scrolling-region>\n        <app-header fixed slot=\"header\">\n          <app-toolbar>\n            <ha-menu-button\n              .hass=", "\n              .narrow=", "\n            ></ha-menu-button>\n            <div main-title>", "</div>\n          </app-toolbar>\n          <paper-tabs\n            scrollable\n            attr-for-selected=\"page-name\"\n            .selected=", "\n            @iron-activate=", "\n          >\n            <paper-tab page-name=\"state\">\n              ", "\n            </paper-tab>\n            <paper-tab page-name=\"service\">\n              ", "\n            </paper-tab>\n            <paper-tab page-name=\"logs\">\n              ", "\n            </paper-tab>\n            <paper-tab page-name=\"template\">\n              ", "\n            </paper-tab>\n            <paper-tab page-name=\"event\">\n              ", "\n            </paper-tab>\n            ", "\n            <paper-tab page-name=\"info\">\n              ", "\n            </paper-tab>\n          </paper-tabs>\n        </app-header>\n        <developer-tools-router\n          .route=", "\n          .narrow=", "\n          .hass=", "\n        ></developer-tools-router>\n      </app-header-layout>\n    "], ["\n      <app-header-layout has-scrolling-region>\n        <app-header fixed slot=\"header\">\n          <app-toolbar>\n            <ha-menu-button\n              .hass=", "\n              .narrow=", "\n            ></ha-menu-button>\n            <div main-title>", "</div>\n          </app-toolbar>\n          <paper-tabs\n            scrollable\n            attr-for-selected=\"page-name\"\n            .selected=", "\n            @iron-activate=", "\n          >\n            <paper-tab page-name=\"state\">\n              ",
            ...
            "\n            </paper-tab>\n            <paper-tab page-name=\"event\">\n              ",
            "\n            </paper-tab>\n            ",
            "\n            <paper-tab page-name=\"info\">\n              ", "\n            </paper-tab>\n          </paper-tabs>\n        </app-header>\n        <developer-tools-router\n          .route=", "\n          .narrow=", "\n          .hass=", "\n        ></developer-tools-router>\n      </app-header-layout>\n    "])), this.hass, this.narrow, this.hass.localize("panel.developer_tools"), page, this.handlePageSelected, this.hass.localize("ui.panel.developer-tools.tabs.states.title"), this.hass.localize("ui.panel.developer-tools.tabs.services.title"), this.hass.localize("ui.panel.developer-tools.tabs.logs.title"), this.hass.localize("ui.panel.developer-tools.tabs.templates.title"), this.hass.localize("ui.panel.developer-tools.tabs.events.title"), Object(_common_config_is_component_loaded__WEBPACK_IMPORTED_MODULE_13__["default"])(this.hass, "mqtt")
            ? Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n                  <paper-tab page-name=\"mqtt\">\n                    ", "\n                  </paper-tab>\n                "], ["\n                  <paper-tab page-name=\"mqtt\">\n                    ",
                "\n                  </paper-tab>\n                "])), this.hass.localize("ui.panel.developer-tools.tabs.mqtt.title")) : "", this.hass.localize("ui.panel.developer-tools.tabs.info.title"), this.route, this.narrow, this.hass);
    };
    PanelDeveloperTools.prototype.handlePageSelected = function (ev) {
    ...
    Object.defineProperty(PanelDeveloperTools.prototype, "_page", {
        get: function () {
    ...
    Object.defineProperty(PanelDeveloperTools, "styles", {
        get: function () {
            return [
