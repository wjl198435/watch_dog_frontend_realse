...
var HuiDialogEditLovelace = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(HuiDialogEditLovelace, _super);
    function HuiDialogEditLovelace() {
        var _this = _super.call(this) || this;
        _this._saving = false;
        return _this;
    }
    HuiDialogEditLovelace.prototype.showDialog = function (lovelace) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var _a, views, lovelaceConfig;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        _a = this._lovelace.config, views = _a.views, lovelaceConfig = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["views"]);
    ...
    Object.defineProperty(HuiDialogEditLovelace.prototype, "_dialog", {
        get: function () {
    ...
    HuiDialogEditLovelace.prototype.render = function () {
    ...
    HuiDialogEditLovelace.prototype._closeDialog = function () {
        this._config = undefined;
        this._dialog.close();
    };
    HuiDialogEditLovelace.prototype._save = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var lovelace, config, err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        config = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, lovelace.config), this._config);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, lovelace.saveConfig(config)];
                    case 2:
                        _a.sent();
                        this._closeDialog();
                        return [3 /*break*/, 5];
    ...
    HuiDialogEditLovelace.prototype._ConfigChanged = function (ev) {
        if (ev.detail && ev.detail.config) {
            this._config = ev.detail.config;
        }
    };
    HuiDialogEditLovelace.prototype._isConfigChanged = function () {
        var _a = this._lovelace.config, views = _a.views, lovelaceConfig = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_a, ["views"]);
        return JSON.stringify(this._config) !== JSON.stringify(lovelaceConfig);
    };
    Object.defineProperty(HuiDialogEditLovelace, "styles", {
        get: function () {
            return [
...
var HuiLovelaceEditor = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(HuiLovelaceEditor, _super);
    function HuiLovelaceEditor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(HuiLovelaceEditor.prototype, "_title", {
        get: function () {
            if (!this.config) {
                return "";
            }
    ...
    HuiLovelaceEditor.prototype.render = function () {
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      ", "\n      <div class=\"card-config\">\n        <paper-input\n          label=\"Title\"\n          .value=\"", "\"\n          .configValue=\"", "\"\n          @value-changed=\"", "\"\n        ></paper-input>\n      </div>\n    "], ["\n      ", "\n      <div class=\"card-config\">\n        <paper-input\n          label=\"Title\"\n          .value=\"", "\"\n          .configValue=\"", "\"\n          @value-changed=\"", "\"\n        ></paper-input>\n      </div>\n    "])), _config_elements_config_elements_style__WEBPACK_IMPORTED_MODULE_4__["configElementStyle"], this._title, "title", this._valueChanged);
    };
    HuiLovelaceEditor.prototype._valueChanged = function (ev) {
        var _a;
        if (!this.config) {
            return;
        }
        ...
        if (target.configValue) {
            newConfig = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, this.config), (_a = {}, _a[target.configValue] = target.value, _a));
        }
