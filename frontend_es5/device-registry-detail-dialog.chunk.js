...
var DialogDeviceRegistryDetail = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DialogDeviceRegistryDetail, _super);
    function DialogDeviceRegistryDetail() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DialogDeviceRegistryDetail.prototype.showDialog = function (params) {
    ...
    DialogDeviceRegistryDetail.prototype.connectedCallback = function () {
        var _this = this;
        _super.prototype.connectedCallback.call(this);
        this._unsubAreas = Object(_data_area_registry__WEBPACK_IMPORTED_MODULE_10__["subscribeAreaRegistry"])(this.hass.connection, function (areas) {
            _this._areas = areas;
        });
    };
    DialogDeviceRegistryDetail.prototype.disconnectedCallback = function () {
        _super.prototype.disconnectedCallback.call(this);
        if (this._unsubAreas) {
            this._unsubAreas();
        }
    };
    DialogDeviceRegistryDetail.prototype.render = function () {
        if (!this._params) {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>", "</h2>\n        <paper-dialog-scrollable>\n          ", "\n          <div class=\"form\">\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              .label=", "\n              .placeholder=", "\n              .disabled=", "\n            ></paper-input>\n            <div class=\"area\">\n              <paper-dropdown-menu label=\"Area\" class=\"flex\">\n                <paper-listbox\n                  slot=\"dropdown-content\"\n                  .selected=\"", "\"\n                  @iron-select=\"", "\"\n                >\n                  <paper-item>\n                    ", "\n                  </paper-item>\n                  ", "\n                </paper-listbox>\n              </paper-dropdown-menu>\n            </div>\n          </div>\n        </paper-dialog-scrollable>\n        <div class=\"paper-dialog-buttons\">\n          <mwc-button @click=\"", "\">\n            ", "\n          </mwc-button>\n        </div>\n      </ha-paper-dialog>\n    "], ["\n      <ha-paper-dialog\n        with-backdrop\n        opened\n        @opened-changed=\"", "\"\n      >\n        <h2>", "</h2>\n        <paper-dialog-scrollable>\n          ",
            "\n          <div class=\"form\">\n            <paper-input\n              .value=", "\n              @value-changed=", "\n              .label=", "\n              .placeholder=", "\n              .disabled=", "\n            ></paper-input>\n            <div class=\"area\">\n              <paper-dropdown-menu label=\"Area\" class=\"flex\">\n                <paper-listbox\n                  slot=\"dropdown-content\"\n                  .selected=\"", "\"\n                  @iron-select=\"", "\"\n                >\n                  <paper-item>\n                    ",
            "\n                  </paper-item>\n                  ", "\n                </paper-listbox>\n              </paper-dropdown-menu>\n            </div>\n          </div>\n        </paper-dialog-scrollable>\n        <div class=\"paper-dialog-buttons\">\n          <mwc-button @click=\"", "\">\n            ",
            "\n          </mwc-button>\n        </div>\n      </ha-paper-dialog>\n    "])), this._openedChanged, device.name || "Unnamed device", this._error
            ? Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n                <div class=\"error\">", "</div>\n              "], ["\n                <div class=\"error\">", "</div>\n              "])), this._error) : "", this._nameByUser, this._nameChanged, this.hass.localize("ui.dialogs.more_info_settings.name"), device.name || "", this._submitting, this._computeSelectedArea(), this._areaIndexChanged, this.hass.localize("ui.panel.config.integrations.config_entry.no_area"), this._renderAreas(), this._updateEntry, this.hass.localize("ui.panel.config.entity_registry.editor.update"));
    };
    DialogDeviceRegistryDetail.prototype._nameChanged = function (ev) {
        this._error = undefined;
        this._nameByUser = ev.detail.value;
    };
    DialogDeviceRegistryDetail.prototype._renderAreas = function () {
        if (!this._areas) {
            return;
        }
        return this._areas.map(function (area) { return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n        <paper-item>", "</paper-item>\n      "], ["\n        <paper-item>", "</paper-item>\n      "])), area.name); });
    };
    DialogDeviceRegistryDetail.prototype._computeSelectedArea = function () {
        ...
        return this._areas.findIndex(function (area) { return area.area_id === device.area_id; }) + 1;
    };
    DialogDeviceRegistryDetail.prototype._areaIndexChanged = function (event) {
    ...
    DialogDeviceRegistryDetail.prototype._updateEntry = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._params.updateEntry({
    ...
    DialogDeviceRegistryDetail.prototype._openedChanged = function (ev) {
        if (!ev.detail.value) {
            this._params = undefined;
        }
    };
    Object.defineProperty(DialogDeviceRegistryDetail, "styles", {
        get: function () {
            return [
