 ...
 */
var listenMediaQuery = function (mediaQuery, matchesChanged) {
    var mql = matchMedia(mediaQuery);
    var listener = function (e) { return matchesChanged(e.matches); };
    mql.addListener(listener);
    matchesChanged(mql.matches);
    return function () { return mql.removeListener(listener); };
};
...
var fetchCloudStatus = function (hass) {
    return hass.callWS({ type: "cloud/status" });
};
var createCloudhook = function (hass, webhookId) {
    return hass.callWS({
        type: "cloud/cloudhook/create",
        webhook_id: webhookId,
    });
};
var deleteCloudhook = function (hass, webhookId) {
    return hass.callWS({
        type: "cloud/cloudhook/delete",
        webhook_id: webhookId,
    });
};
var connectCloudRemote = function (hass) {
    return hass.callWS({
        type: "cloud/remote/connect",
    });
};
var disconnectCloudRemote = function (hass) {
    return hass.callWS({
        type: "cloud/remote/disconnect",
    });
};
var fetchCloudSubscriptionInfo = function (hass) {
    return hass.callWS({ type: "cloud/subscription" });
};
var updateCloudPref = function (hass, prefs) {
    return hass.callWS(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ type: "cloud/update_prefs" }, prefs));
};
var updateCloudGoogleEntityConfig = function (hass, entityId, values) {
    return hass.callWS(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ type: "cloud/google_assistant/entities/update", entity_id: entityId }, values));
};
var cloudSyncGoogleAssistant = function (hass) {
    return hass.callApi("POST", "cloud/google_actions/sync");
};
var updateCloudAlexaEntityConfig = function (hass, entityId, values) {
    return hass.callWS(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ type: "cloud/alexa/entities/update", entity_id: entityId }, values));
};
...
var HaPanelConfig = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(HaPanelConfig, _super);
        ...
        _this.routerOptions = {
            ...
            routes: {
                area_registry: {
                    ...
                    load: function () {
                        return Promise.all(/*! import() | panel-config-area-registry */[__webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-area-registry"), __webpack_require__.e("panel-config-area-registry")]).then(__webpack_require__.bind(null, /*! ./area_registry/ha-config-area-registry */ "./src/panels/config/area_registry/ha-config-area-registry.ts"));
                    },
                },
                automation: {
                    tag: "ha-config-automation",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-automation */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e(5), __webpack_require__.e("vendors~config-entry-system-options~more-info-dialog~panel-config-automation~panel-config-cloud~pane~be267696"), __webpack_require__.e("vendors~hui-dialog-edit-card~hui-entity-button-card-editor~hui-markdown-card-editor~hui-picture-card~0273678c"), __webpack_require__.e(6), __webpack_require__.e("vendors~dialog-config-flow~ha-mfa-module-setup-flow~more-info-dialog~panel-config-automation~panel-c~a4d29058"), __webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-automation~panel-config-devices~panel-config-integrations~panel-config-script~p~227a5ab6"), __webpack_require__.e(9), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~panel-config-automation~panel-config-script~panel-kiosk~~500bf1bb"), __webpack_require__.e(11), __webpack_require__.e("vendors~onboarding-core-config~panel-config-automation~panel-config-core~panel-config-script"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-script"), __webpack_require__.e("vendors~panel-config-automation"), __webpack_require__.e(4), __webpack_require__.e(10), __webpack_require__.e("panel-config-automation~panel-config-script~panel-config-zwave~panel-kiosk~panel-lovelace~panel-states"), __webpack_require__.e("more-info-dialog~panel-config-automation~panel-kiosk~panel-lovelace~panel-states"), __webpack_require__.e("dialog-config-flow~ha-mfa-module-setup-flow~panel-config-automation~panel-config-script"), __webpack_require__.e("panel-config-automation~panel-config-devices~panel-config-script"), __webpack_require__.e("panel-config-automation~panel-config-script"), __webpack_require__.e("panel-config-automation")]).then(__webpack_require__.bind(null, /*! ./automation/ha-config-automation */ "./src/panels/config/automation/ha-config-automation.js"));
                    },
                },
                cloud: {
                    tag: "ha-config-cloud",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-cloud */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~config-entry-system-options~more-info-dialog~panel-config-automation~panel-config-cloud~pane~be267696"), __webpack_require__.e(6), __webpack_require__.e("vendors~panel-config-cloud"), __webpack_require__.e(7), __webpack_require__.e("panel-config-cloud~panel-config-zwave"), __webpack_require__.e("panel-config-cloud")]).then(__webpack_require__.bind(null, /*! ./cloud/ha-config-cloud */ "./src/panels/config/cloud/ha-config-cloud.ts"));
                    },
                },
                core: {
                    tag: "ha-config-core",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-core */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~onboarding-core-config~panel-config-automation~panel-config-core~panel-config-script"), __webpack_require__.e("vendors~onboarding-core-config~panel-config-core"), __webpack_require__.e(7), __webpack_require__.e("panel-config-core")]).then(__webpack_require__.bind(null, /*! ./core/ha-config-core */ "./src/panels/config/core/ha-config-core.js"));
                    },
                },
                devices: {
                    tag: "ha-config-devices",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-devices */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~config-entry-system-options~more-info-dialog~panel-config-automation~panel-config-cloud~pane~be267696"), __webpack_require__.e("vendors~panel-config-automation~panel-config-devices~panel-config-integrations~panel-config-script~p~227a5ab6"), __webpack_require__.e("vendors~hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("vendors~panel-config-devices~panel-config-entity-registry~panel-config-integrations~panel-lovelace"), __webpack_require__.e("vendors~panel-config-devices~panel-config-integrations"), __webpack_require__.e(4), __webpack_require__.e("hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("panel-config-automation~panel-config-devices~panel-config-script"), __webpack_require__.e("panel-config-devices~panel-config-integrations"), __webpack_require__.e("panel-config-devices")]).then(__webpack_require__.bind(null, /*! ./devices/ha-config-devices */ "./src/panels/config/devices/ha-config-devices.ts"));
                    },
                },
                server_control: {
                    tag: "ha-config-server-control",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-server-control */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e(7), __webpack_require__.e("panel-config-server-control")]).then(__webpack_require__.bind(null, /*! ./server_control/ha-config-server-control */ "./src/panels/config/server_control/ha-config-server-control.js"));
                    },
                },
                customize: {
                    tag: "ha-config-customize",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-customize */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e(5), __webpack_require__.e("vendors~panel-config-customize"), __webpack_require__.e("panel-config-customize")]).then(__webpack_require__.bind(null, /*! ./customize/ha-config-customize */ "./src/panels/config/customize/ha-config-customize.js"));
                    },
                },
                dashboard: {
                    tag: "ha-config-dashboard",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-dashboard */[__webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~panel-config-dashboard"), __webpack_require__.e("panel-config-dashboard")]).then(__webpack_require__.bind(null, /*! ./dashboard/ha-config-dashboard */ "./src/panels/config/dashboard/ha-config-dashboard.js"));
                    },
                },
                entity_registry: {
                    tag: "ha-config-entity-registry",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-entity-registry */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~config-entry-system-options~more-info-dialog~panel-config-automation~panel-config-cloud~pane~be267696"), __webpack_require__.e("vendors~hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("vendors~panel-config-devices~panel-config-entity-registry~panel-config-integrations~panel-lovelace"), __webpack_require__.e("hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("panel-config-entity-registry")]).then(__webpack_require__.bind(null, /*! ./entity_registry/ha-config-entity-registry */ "./src/panels/config/entity_registry/ha-config-entity-registry.ts"));
                    },
                },
                integrations: {
                    tag: "ha-config-integrations",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-integrations */[__webpack_require__.e(0), __webpack_require__.e(1), __webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-automation~panel-config-devices~panel-config-integrations~panel-config-script~p~227a5ab6"), __webpack_require__.e(8), __webpack_require__.e(11), __webpack_require__.e("vendors~hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("vendors~panel-config-devices~panel-config-entity-registry~panel-config-integrations~panel-lovelace"), __webpack_require__.e("vendors~panel-config-devices~panel-config-integrations"), __webpack_require__.e(4), __webpack_require__.e("hui-unused-entities~panel-config-devices~panel-config-entity-registry~panel-config-integrations"), __webpack_require__.e("panel-config-devices~panel-config-integrations"), __webpack_require__.e("panel-config-integrations")]).then(__webpack_require__.bind(null, /*! ./integrations/ha-config-integrations */ "./src/panels/config/integrations/ha-config-integrations.ts"));
                    },
                },
                person: {
                    tag: "ha-config-person",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-person */[__webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-person~panel-config-users"), __webpack_require__.e("panel-config-person")]).then(__webpack_require__.bind(null, /*! ./person/ha-config-person */ "./src/panels/config/person/ha-config-person.ts"));
                    },
                },
                script: {
                    tag: "ha-config-script",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-script */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e(2), __webpack_require__.e(3), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e(5), __webpack_require__.e("vendors~hui-dialog-edit-card~hui-entity-button-card-editor~hui-markdown-card-editor~hui-picture-card~0273678c"), __webpack_require__.e("vendors~dialog-config-flow~ha-mfa-module-setup-flow~more-info-dialog~panel-config-automation~panel-c~a4d29058"), __webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-automation~panel-config-devices~panel-config-integrations~panel-config-script~p~227a5ab6"), __webpack_require__.e(9), __webpack_require__.e("vendors~dialog-config-flow~more-info-dialog~panel-config-automation~panel-config-script~panel-kiosk~~500bf1bb"), __webpack_require__.e("vendors~onboarding-core-config~panel-config-automation~panel-config-core~panel-config-script"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-script"), __webpack_require__.e("vendors~panel-config-script"), __webpack_require__.e(4), __webpack_require__.e(10), __webpack_require__.e("panel-config-automation~panel-config-script~panel-config-zwave~panel-kiosk~panel-lovelace~panel-states"), __webpack_require__.e("dialog-config-flow~ha-mfa-module-setup-flow~panel-config-automation~panel-config-script"), __webpack_require__.e("panel-config-automation~panel-config-devices~panel-config-script"), __webpack_require__.e("panel-config-automation~panel-config-script"), __webpack_require__.e("panel-config-script")]).then(__webpack_require__.bind(null, /*! ./script/ha-config-script */ "./src/panels/config/script/ha-config-script.js"));
                    },
                },
                users: {
                    tag: "ha-config-users",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-users */[__webpack_require__.e("vendors~hui-unused-entities~hui-view-editable~panel-config-area-registry~panel-config-automation~pan~6ac00806"), __webpack_require__.e("vendors~panel-config-automation~panel-config-devices~panel-config-integrations~panel-config-script~p~227a5ab6"), __webpack_require__.e("vendors~panel-config-person~panel-config-users"), __webpack_require__.e("panel-config-users")]).then(__webpack_require__.bind(null, /*! ./users/ha-config-users */ "./src/panels/config/users/ha-config-users.js"));
                    },
                },
                zha: {
                ...
                zwave: {
                    tag: "ha-config-zwave",
                    load: function () {
                        return Promise.all(/*! import() | panel-config-zwave */[__webpack_require__.e(0), __webpack_require__.e("vendors~area-registry-detail-dialog~cloud-webhook-manage-dialog~config-entry-system-options~device-r~780fc7fc"), __webpack_require__.e(1), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~ha-sidebar~more-info~702391a3"), __webpack_require__.e("vendors~panel-calendar~panel-config-automation~panel-config-core~panel-config-customize~panel-config~c123bdd1"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~482d8d48"), __webpack_require__.e("vendors~device-registry-detail-dialog~dialog-config-flow~dialog-zha-device-info~more-info-dialog~pan~aeba8a04"), __webpack_require__.e(5), __webpack_require__.e("vendors~dialog-zha-device-info~panel-config-zwave~zha-add-devices-page~zha-configuration-page"), __webpack_require__.e(7), __webpack_require__.e("panel-config-automation~panel-config-script~panel-config-zwave~panel-kiosk~panel-lovelace~panel-states"), __webpack_require__.e("panel-config-cloud~panel-config-zwave"), __webpack_require__.e("panel-config-zwave")]).then(__webpack_require__.bind(null, /*! ./zwave/ha-config-zwave */ "./src/panels/config/zwave/ha-config-zwave.js"));
                    },
                },
            },
        };
        _this._wideSidebar = false;
        _this._wide = false;
        _this._listeners = [];
        return _this;
    }
    HaPanelConfig.prototype.connectedCallback = function () {
        var _this = this;
        _super.prototype.connectedCallback.call(this);
        this._listeners.push(Object(_common_dom_media_query__WEBPACK_IMPORTED_MODULE_5__["listenMediaQuery"])("(min-width: 1040px)", function (matches) {
            _this._wide = matches;
        }));
        this._listeners.push(Object(_common_dom_media_query__WEBPACK_IMPORTED_MODULE_5__["listenMediaQuery"])("(min-width: 1296px)", function (matches) {
            _this._wideSidebar = matches;
        }));
        this._listeners.push(Object(_data_frontend__WEBPACK_IMPORTED_MODULE_7__["getOptimisticFrontendUserDataCollection"])(this.hass.connection, "core").subscribe(function (coreUserData) {
            _this._coreUserData = coreUserData || {};
        }));
    };
    HaPanelConfig.prototype.disconnectedCallback = function () {
        _super.prototype.disconnectedCallback.call(this);
        while (this._listeners.length) {
            this._listeners.pop()();
        }
    };
    HaPanelConfig.prototype.firstUpdated = function (changedProps) {
        var _this = this;
        ...
        this.addEventListener("ha-refresh-cloud-status", function () {
            return _this._updateCloudStatus();
        });
    };
    HaPanelConfig.prototype.updatePageEl = function (el) {
    ...
    HaPanelConfig.prototype._updateCloudStatus = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, Object(_data_cloud__WEBPACK_IMPORTED_MODULE_4__["fetchCloudStatus"])(this.hass)];
                    case 1:
                        _a._cloudStatus = _b.sent();
                        if (this._cloudStatus.cloud === "connecting") {
                            setTimeout(function () { return _this._updateCloudStatus(); }, 5000);
                        }
                        return [2 /*return*/];
                }
            });
