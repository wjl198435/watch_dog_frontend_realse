...
/* harmony import */ var _polymer_app_layout_app_header_layout_app_header_layout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @polymer/app-layout/app-header-layout/app-header-layout */ "./node_modules/@polymer/app-layout/app-header-layout/app-header-layout.js");
/* harmony import */ var _polymer_app_layout_app_header_app_header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @polymer/app-layout/app-header/app-header */ "./node_modules/@polymer/app-layout/app-header/app-header.js");
...
/* harmony import */ var _polymer_paper_spinner_paper_spinner__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @polymer/paper-spinner/paper-spinner */ "./node_modules/@polymer/paper-spinner/paper-spinner.js");
...
/* harmony import */ var _components_ha_code_editor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../components/ha-code-editor */ "./src/components/ha-code-editor.ts");
...
var lovelaceStruct = _common_structs_struct__WEBPACK_IMPORTED_MODULE_10__["struct"].interface({
    title: "string?",
    views: ["object"],
    resources: _common_structs_struct__WEBPACK_IMPORTED_MODULE_10__["struct"].optional(["object"]),
});
var LovelaceFullConfigEditor = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(LovelaceFullConfigEditor, _super);
    function LovelaceFullConfigEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._generation = 1;
        return _this;
    }
    Object.defineProperty(LovelaceFullConfigEditor, "properties", {
        get: function () {
            return {
                hass: {},
                lovelace: {},
    ...
    LovelaceFullConfigEditor.prototype.render = function () {
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      <app-header-layout>\n        <app-header>\n          <app-toolbar>\n            <paper-icon-button\n              icon=\"hass:close\"\n              @click=\"", "\"\n            ></paper-icon-button>\n            <div main-title>\n              ", "\n            </div>\n            <div\n              class=\"save-button\n              ", "\"\n            >\n              ", "\n            </div>\n            <mwc-button raised @click=\"", "\"\n              >", "</mwc-button\n            >\n          </app-toolbar>\n        </app-header>\n        <div class=\"content\">\n          <ha-code-editor\n            mode=\"yaml\"\n            autofocus\n            .rtl=", "\n            .hass=\"", "\"\n            @value-changed=\"", "\"\n            @editor-save=\"", "\"\n          >\n          </ha-code-editor>\n        </div>\n      </app-header-layout>\n    "], ["\n      <app-header-layout>\n        <app-header>\n          <app-toolbar>\n            <paper-icon-button\n              icon=\"hass:close\"\n              @click=\"", "\"\n            ></paper-icon-button>\n            <div main-title>\n              ",
            ...
            "\"\n            >\n              ",
            "\n            </div>\n            <mwc-button raised @click=\"", "\"\n              >",
            "</mwc-button\n            >\n          </app-toolbar>\n        </app-header>\n        <div class=\"content\">\n          <ha-code-editor\n            mode=\"yaml\"\n            autofocus\n            .rtl=", "\n            .hass=\"", "\"\n            @value-changed=\"", "\"\n            @editor-save=\"", "\"\n          >\n          </ha-code-editor>\n        </div>\n      </app-header-layout>\n    "])), this._closeEditor, this.hass.localize("ui.panel.lovelace.editor.raw_editor.header"), Object(lit_html_directives_class_map__WEBPACK_IMPORTED_MODULE_2__["classMap"])({
            saved: this._saving === false || this._changed === true,
        }), this._changed
            ? this.hass.localize("ui.panel.lovelace.editor.raw_editor.unsaved_changes")
            : this.hass.localize("ui.panel.lovelace.editor.raw_editor.saved"), this._handleSave, this.hass.localize("ui.panel.lovelace.editor.raw_editor.save"), Object(_common_util_compute_rtl__WEBPACK_IMPORTED_MODULE_14__["computeRTL"])(this.hass), this.hass, this._yamlChanged, this._handleSave);
    };
    LovelaceFullConfigEditor.prototype.firstUpdated = function () {
        this.yamlEditor.value = js_yaml__WEBPACK_IMPORTED_MODULE_3___default.a.safeDump(this.lovelace.config);
    };
    Object.defineProperty(LovelaceFullConfigEditor, "styles", {
        get: function () {
            return [
    ...
    LovelaceFullConfigEditor.prototype._yamlChanged = function () {
    ...
    LovelaceFullConfigEditor.prototype._closeEditor = function () {
        if (this._changed) {
    ...
    LovelaceFullConfigEditor.prototype._handleSave = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var value, err_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        try {
                            value = js_yaml__WEBPACK_IMPORTED_MODULE_3___default.a.safeLoad(this.yamlEditor.value);
                        }
                        catch (err) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.lovelace.saveConfig(value)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _a.sent();
                        alert("Unable to save YAML: " + err_1);
                        return [3 /*break*/, 4];
                    case 4:
    ...
    Object.defineProperty(LovelaceFullConfigEditor.prototype, "yamlEditor", {
        get: function () {
